...
image = np.array(Image.open('data/toy_examples/gandalf.png'))
...
class FasterRCNNBoxScoreTarget:
    def __init__(self, labels, bounding_boxes, iou_threshold=0.5,device='cpu'):
        self.labels = labels
...
targets = [FasterRCNNBoxScoreTarget(labels=labels, bounding_boxes=boxes, device=device)]
...
resultxai.save('detections_ScoreCAM.jpg')
...
image_with_bounding_boxes = draw_boxes(boxes, labels, classes, cam_image)
resultxai = Image.fromarray(image_with_bounding_boxes)
resultxai.save('detections_EIGENCAM.jpg')
...
image_with_bounding_boxes = draw_boxes(boxes, labels, classes, cam_image)
resultxai = Image.fromarray(image_with_bounding_boxes)
resultxai.save('detections_AblationCAM.jpg')
